...
export default class Movies extends Component {
    ...
    render() {
        ...
        let { movies, currSearchText, limit, currentPage,genres,currGenre } = this.state;
        let filterMovies = [];
        ...
        //implementing filteration according to genres
        ...
        if (filterMovies.length == 0 && movies.length != 0) {
                            ...
                            <div className="row">
                                <div className="col-3">
                                    <ul class="list-group">
                                       {
                                            genres.map((genre)=>{
                                                let class_state=genre.name==currGenre ? "list-group-item active" : "list-group-item";
                                                return(
                                                <li onClick={()=> this.handleGenres(genre.name)} key={genre._id} className={class_state}>{genre.name}</li>
                                                )
                                            })
                                       }
                                    </ul>
